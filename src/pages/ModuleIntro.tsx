...
export const ModuleIntro = () => {
  ...
  return <PageShell><MirrorPane>
    ...
    <div className="mt-6 rounded-2xl border border-primary/15 bg-primary/5 p-5"><p className="text-xs font-bold uppercase tracking-wide text-primary">{language === 'id' ? 'KONTEKS PENGGUNAAN' : language === 'nl' ? 'GEBRUIKSCONTEXT' : 'USAGE CONTEXT'}</p><p className="mt-2 text-sm leading-relaxed text-ink">{t.common.usageContext}</p><p className="mt-2 text-xs leading-relaxed text-muted">{t.common.trainerRole}</p></div>
